...
public class Options : AutoConfigOptions
{
    ...
    [Config(ADVANCED, "/40 Shield Full Time", "How long the shield can be at full strength, expressed in ticks (40 ticks == 1 second)")]
    public static int ShieldFullTime = 40;
    [Config(ADVANCED, "/40 Shield Max Time", "How long the shield can be up at all, expressed in ticks (40 ticks == 1 second)", rightSide = true)]
